...
- Cagayan’s official provincial history describes Lal-lo as part of the former Nueva Segovia area and identifies shell-midden sites in Lal-lo and Gattaran.
- The [NHCP registry entry for Lalloc-Nueva Segovia](https://philhistoricsites.nhcp.gov.ph/registry_database/lalloc-nueva-segovia/) recognizes the historical site and Diocese of Nueva Segovia.
- A [2026 provincial publication](https://cagayan.gov.ph/bagong-tourism-heritage-site-projects-sa-bayan-ng-lal-lo-pormal-nang-pinasinayaan/) reports heritage projects at the Tocolana Church and Hospital Ruins in Tucalana and the Evangelization Cross in Centro. The article is cited as a dated project report, not as a claim that every site is currently open.
...
- [Provincial Government of Cagayan — History](https://cagayan.gov.ph/history/)
- [NHCP — Lalloc-Nueva Segovia registry](https://philhistoricsites.nhcp.gov.ph/registry_database/lalloc-nueva-segovia/)
