...
- **🌐 Multilingual Support**: English and Filipino now, with room for future Philippine-language translations
...
```yaml
name: 'Municipality of Lal-lo'
type: 'City' # or "Municipality"
region: 'Cagayan Valley (Region II)'
province: 'Cagayan'
mayor: 'Hon. Oliver Pascual'
...
```markdown
# Service Title — Municipality of Lal-lo
